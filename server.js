...
app.use((req, res, next) => {
  ...
  const csp = [
    ...
    "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://accounts.google.com https://ipapi.co https://freeipapi.com https://ipwho.is https://*.tile.openstreetmap.org https://router.project-osrm.org",

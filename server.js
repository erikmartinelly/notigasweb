...
app.use((req, res, next) => {
  ...
  const csp = [
    ...
    // Imágenes (OSM tiles + Supabase Storage + Google user avatars + CDNs + data URIs para favicons dinámicos)
    "img-src 'self' data: blob: https://*.tile.openstreetmap.org https://*.supabase.co https://pagead2.googlesyndication.com https://*.google.com https://*.googleusercontent.com https://unpkg.com https://cdnjs.cloudflare.com",

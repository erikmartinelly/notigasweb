...
(function () {
  ...
  function buildAvailablePopup(row) {
    ...
    const takeButton = isDriverMode()
      ...
      : '';
    return `<div style="min-width:180px;line-height:1.4;"><strong>Pedido disponible</strong><br><span>Ubicación aproximada dentro de un área de ${radius} m.</span>${takeButton}</div>`;
  }
  ...
  window.tomarPedidoDesdeZonaPrivada = function (orderId, lat, lng) {

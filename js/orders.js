...
async function renderDriverOrdersList() {
  ...
  // Plataforma 100% Gratuita: Todos los repartidores ven todos los pedidos vecinales en tiempo real de inmediato
  ...
  // Banner informativo superior de Acceso Gratuito en Tiempo Real
  const planBannerHtml = `
    <div class="driver-plan-banner" style="background:linear-gradient(135deg, rgba(16,185,129,0.15) 0%, rgba(15,23,42,0.9) 100%); border:1.5px solid #10B981; border-radius:10px; padding:10px 12px; margin-bottom:12px; display:flex; align-items:center; justify-content:space-between; gap:10px;">
      <div style="display:flex; align-items:center; gap:8px;">
        <span style="font-size:20px;">⚡</span>
        <div style="font-size:11.5px; color:#A7F3D0; line-height:1.4;">
          <strong style="color:#FFFFFF; font-size:12px; display:block;">Pedidos Vecinales en Tiempo Real</strong>
          Acceso 100% gratuito e inmediato para todos los repartidores.
        </div>
      </div>
      <span style="font-size:10px; background:#10B981; color:#064E3B; font-weight:900; padding:3px 8px; border-radius:6px; white-space:nowrap;">EN VIVO 🟢</span>
    </div>
  `;

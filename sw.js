/* NOTIGAS SERVICE WORKER v88.0 - CACHÉ PROGRESIVO Y MODO OFFLINE */
const CACHE_NAME = 'notigas-cache-v88';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './styles/main.css?v=88',
  './js/state.js?v=88',
  './js/ui.js?v=88',
  './js/supabase-config.js?v=88',
  './js/auth.js?v=88',
  './js/vendors.js?v=88',
  './js/map.js?v=88',
  './js/map_search.js?v=88',
  './js/map_gps.js?v=88',
  './js/forum.js?v=88',
  './js/ads.js?v=88',
  './js/orders.js?v=88',
  './js/admin_users.js?v=88',
  './js/admin.js?v=88',
  './js/app.js?v=88',
  './js/events.js?v=88',

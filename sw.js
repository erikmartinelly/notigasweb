/* NOTIGAS SERVICE WORKER v86.0 - CACHÉ PROGRESIVO Y MODO OFFLINE */
const CACHE_NAME = 'notigas-cache-v86';
const ASSETS_TO_CACHE = [
  ...
  './js/state.js?v=86',
  './js/ui.js?v=86',
  './js/supabase-config.js?v=86',
  './js/auth.js?v=86',
  './js/vendors.js?v=86',
  './js/map.js?v=86',
  './js/map_search.js?v=86',
  './js/map_gps.js?v=86',
  './js/forum.js?v=86',
  './js/ads.js?v=86',
  './js/orders.js?v=86',
  './js/admin_users.js?v=86',
  './js/admin.js?v=86',
  './js/app.js?v=86',
  './js/events.js?v=86',

/* NOTIGAS SERVICE WORKER v96.0 - CACHÉ PROGRESIVO Y MODO OFFLINE */
const CACHE_NAME = 'notigas-cache-v96';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './styles/main.css?v=96',
  './js/state.js?v=96',
  './js/ui.js?v=96',
  './js/supabase-config.js?v=96',
  './js/auth.js?v=96',
  './js/vendors.js?v=96',
  './js/map.js?v=96',
  './js/map_search.js?v=96',
  './js/map_gps.js?v=96',
  './js/forum.js?v=96',
  './js/ads.js?v=96',
  './js/orders.js?v=96',
  './js/admin_users.js?v=96',
  './js/admin.js?v=96',
  './js/app.js?v=96',
  './js/events.js?v=96',

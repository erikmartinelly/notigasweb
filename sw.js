/* NOTIGAS SERVICE WORKER v95.0 - CACHÉ PROGRESIVO Y MODO OFFLINE */
const CACHE_NAME = 'notigas-cache-v95';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './styles/main.css?v=95',
  './js/state.js?v=95',
  './js/ui.js?v=95',
  './js/supabase-config.js?v=95',
  './js/auth.js?v=95',
  './js/vendors.js?v=95',
  './js/map.js?v=95',
  './js/map_search.js?v=95',
  './js/map_gps.js?v=95',
  './js/forum.js?v=95',
  './js/ads.js?v=95',
  './js/orders.js?v=95',
  './js/admin_users.js?v=95',
  './js/admin.js?v=95',
  './js/app.js?v=95',
  './js/events.js?v=95',

/* NOTIGAS SERVICE WORKER v100.0 - CACHÉ PROGRESIVO Y MODO OFFLINE */
const CACHE_NAME = 'notigas-cache-v100';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './styles/main.css?v=100',
  './js/state.js?v=100',
  './js/ui.js?v=100',
  './js/supabase-config.js?v=100',
  './js/auth.js?v=100',
  './js/vendors.js?v=100',
  './js/map.js?v=100',
  './js/map_search.js?v=100',
  './js/map_gps.js?v=100',
  './js/forum.js?v=100',
  './js/ads.js?v=100',
  './js/orders.js?v=100',
  './js/admin_users.js?v=100',
  './js/admin.js?v=100',
  './js/app.js?v=100',
  './js/events.js?v=100',

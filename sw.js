/* NOTIGAS SERVICE WORKER v87.0 - CACHÉ PROGRESIVO Y MODO OFFLINE */
const CACHE_NAME = 'notigas-cache-v87';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './styles/main.css?v=87',
  './js/state.js?v=87',
  './js/ui.js?v=87',
  './js/supabase-config.js?v=87',
  './js/auth.js?v=87',
  './js/vendors.js?v=87',
  './js/map.js?v=87',
  './js/map_search.js?v=87',
  './js/map_gps.js?v=87',
  './js/forum.js?v=87',
  './js/ads.js?v=87',
  './js/orders.js?v=87',
  './js/admin_users.js?v=87',
  './js/admin.js?v=87',
  './js/app.js?v=87',
  './js/events.js?v=87',

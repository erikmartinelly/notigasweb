/* NOTIGAS SERVICE WORKER v99.0 - CACHÉ PROGRESIVO Y MODO OFFLINE */
const CACHE_NAME = 'notigas-cache-v99';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './styles/main.css?v=99',
  './js/state.js?v=99',
  './js/ui.js?v=99',
  './js/supabase-config.js?v=99',
  './js/auth.js?v=99',
  './js/vendors.js?v=99',
  './js/map.js?v=99',
  './js/map_search.js?v=99',
  './js/map_gps.js?v=99',
  './js/forum.js?v=99',
  './js/ads.js?v=99',
  './js/orders.js?v=99',
  './js/admin_users.js?v=99',
  './js/admin.js?v=99',
  './js/app.js?v=99',
  './js/events.js?v=99',

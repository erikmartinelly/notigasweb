/* NOTIGAS SERVICE WORKER v97.0 - CACHÉ PROGRESIVO Y MODO OFFLINE */
const CACHE_NAME = 'notigas-cache-v97';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './styles/main.css?v=97',
  './js/state.js?v=97',
  './js/ui.js?v=97',
  './js/supabase-config.js?v=97',
  './js/auth.js?v=97',
  './js/vendors.js?v=97',
  './js/map.js?v=97',
  './js/map_search.js?v=97',
  './js/map_gps.js?v=97',
  './js/forum.js?v=97',
  './js/ads.js?v=97',
  './js/orders.js?v=97',
  './js/admin_users.js?v=97',
  './js/admin.js?v=97',
  './js/app.js?v=97',
  './js/events.js?v=97',

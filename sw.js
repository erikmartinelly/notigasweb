/* NOTIGAS SERVICE WORKER v101.0 - CACHÉ PROGRESIVO Y MODO OFFLINE */
const CACHE_NAME = 'notigas-cache-v101';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './styles/main.css?v=101',
  './js/state.js?v=101',
  './js/ui.js?v=101',
  './js/supabase-config.js?v=101',
  './js/auth.js?v=101',
  './js/vendors.js?v=101',
  './js/map.js?v=101',
  './js/map_search.js?v=101',
  './js/map_gps.js?v=101',
  './js/forum.js?v=101',
  './js/ads.js?v=101',
  './js/orders.js?v=101',
  './js/admin_users.js?v=101',
  './js/admin.js?v=101',
  './js/app.js?v=101',
  './js/events.js?v=101',

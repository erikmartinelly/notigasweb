/* NOTIGAS SERVICE WORKER v79.0 - CACHÉ PROGRESIVO Y MODO OFFLINE */
const CACHE_NAME = 'notigas-cache-v79';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './styles/main.css?v=79',
  './js/state.js?v=79',
  './js/ui.js?v=79',
  './js/supabase-config.js?v=79',
  './js/auth.js?v=79',
  './js/vendors.js?v=79',
  './js/map.js?v=79',
  './js/map_search.js?v=79',
  './js/map_gps.js?v=79',
  './js/forum.js?v=79',
  './js/ads.js?v=79',
  './js/orders.js?v=79',
  './js/admin.js?v=79',
  './js/admin_users.js?v=79',
  './js/app.js?v=79',
  './js/events.js?v=79',

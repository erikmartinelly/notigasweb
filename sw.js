/* NOTIGAS SERVICE WORKER v91.0 - CACHÉ PROGRESIVO Y MODO OFFLINE */
const CACHE_NAME = 'notigas-cache-v91';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './styles/main.css?v=91',
  './js/state.js?v=91',
  './js/ui.js?v=91',
  './js/supabase-config.js?v=91',
  './js/auth.js?v=91',
  './js/vendors.js?v=91',
  './js/map.js?v=91',
  './js/map_search.js?v=91',
  './js/map_gps.js?v=91',
  './js/forum.js?v=91',
  './js/ads.js?v=91',
  './js/orders.js?v=91',
  './js/admin_users.js?v=91',
  './js/admin.js?v=91',
  './js/app.js?v=91',
  './js/events.js?v=91',

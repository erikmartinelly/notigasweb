/* NOTIGAS SERVICE WORKER v89.0 - CACHÉ PROGRESIVO Y MODO OFFLINE */
const CACHE_NAME = 'notigas-cache-v89';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './styles/main.css?v=89',
  './js/state.js?v=89',
  './js/ui.js?v=89',
  './js/supabase-config.js?v=89',
  './js/auth.js?v=89',
  './js/vendors.js?v=89',
  './js/map.js?v=89',
  './js/map_search.js?v=89',
  './js/map_gps.js?v=89',
  './js/forum.js?v=89',
  './js/ads.js?v=89',
  './js/orders.js?v=89',
  './js/admin_users.js?v=89',
  './js/admin.js?v=89',
  './js/app.js?v=89',
  './js/events.js?v=89',

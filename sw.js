/* NOTIGAS SERVICE WORKER v80.0 - CACHÉ PROGRESIVO Y MODO OFFLINE */
const CACHE_NAME = 'notigas-cache-v80';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './styles/main.css?v=80',
  './js/state.js?v=80',
  './js/ui.js?v=80',
  './js/supabase-config.js?v=80',
  './js/auth.js?v=80',
  './js/vendors.js?v=80',
  './js/map.js?v=80',
  './js/map_search.js?v=80',
  './js/map_gps.js?v=80',
  './js/forum.js?v=80',
  './js/ads.js?v=80',
  './js/orders.js?v=80',
  './js/admin.js?v=80',
  './js/admin_users.js?v=80',
  './js/app.js?v=80',
  './js/events.js?v=80',

/* NOTIGAS SERVICE WORKER v90.0 - CACHÉ PROGRESIVO Y MODO OFFLINE */
const CACHE_NAME = 'notigas-cache-v90';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './styles/main.css?v=90',
  './js/state.js?v=90',
  './js/ui.js?v=90',
  './js/supabase-config.js?v=90',
  './js/auth.js?v=90',
  './js/vendors.js?v=90',
  './js/map.js?v=90',
  './js/map_search.js?v=90',
  './js/map_gps.js?v=90',
  './js/forum.js?v=90',
  './js/ads.js?v=90',
  './js/orders.js?v=90',
  './js/admin_users.js?v=90',
  './js/admin.js?v=90',
  './js/app.js?v=90',
  './js/events.js?v=90',

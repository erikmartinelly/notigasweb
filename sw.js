/* NOTIGAS SERVICE WORKER v94.0 - CACHÉ PROGRESIVO Y MODO OFFLINE */
const CACHE_NAME = 'notigas-cache-v94';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './styles/main.css?v=94',
  './js/state.js?v=94',
  './js/ui.js?v=94',
  './js/supabase-config.js?v=94',
  './js/auth.js?v=94',
  './js/vendors.js?v=94',
  './js/map.js?v=94',
  './js/map_search.js?v=94',
  './js/map_gps.js?v=94',
  './js/forum.js?v=94',
  './js/ads.js?v=94',
  './js/orders.js?v=94',
  './js/admin_users.js?v=94',
  './js/admin.js?v=94',
  './js/app.js?v=94',
  './js/events.js?v=94',

/* NOTIGAS SERVICE WORKER v98.0 - CACHÉ PROGRESIVO Y MODO OFFLINE */
const CACHE_NAME = 'notigas-cache-v98';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './styles/main.css?v=98',
  './js/state.js?v=98',
  './js/ui.js?v=98',
  './js/supabase-config.js?v=98',
  './js/auth.js?v=98',
  './js/vendors.js?v=98',
  './js/map.js?v=98',
  './js/map_search.js?v=98',
  './js/map_gps.js?v=98',
  './js/forum.js?v=98',
  './js/ads.js?v=98',
  './js/orders.js?v=98',
  './js/admin_users.js?v=98',
  './js/admin.js?v=98',
  './js/app.js?v=98',
  './js/events.js?v=98',

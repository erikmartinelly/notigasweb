/* NOTIGAS SERVICE WORKER v77.0 - CACHÉ PROGRESIVO Y MODO OFFLINE */
const CACHE_NAME = 'notigas-cache-v77';
const ASSETS_TO_CACHE = [
  './',
  './index.html',
  './styles/main.css?v=77',
  './js/state.js?v=77',
  './js/ui.js?v=77',
  './js/supabase-config.js?v=77',
  './js/auth.js?v=77',
  './js/vendors.js?v=77',
  './js/map.js?v=77',
  './js/map_search.js?v=77',
  './js/map_gps.js?v=77',
  './js/forum.js?v=77',
  './js/ads.js?v=77',
  './js/orders.js?v=77',
  './js/admin.js?v=77',
  './js/admin_users.js?v=77',
  './js/app.js?v=77',
  './js/events.js?v=77',
